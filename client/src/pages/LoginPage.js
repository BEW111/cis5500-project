    ...
    <Container component="main" maxWidth="xs">
      <Paper elevation={3} sx={{ mt: 8, p: 4, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        {!showSignUp && !showSignIn && (
          <Box sx={{ mt: 2 }}>
            <Button variant="outlined" color="primary" fullWidth onClick={() => { setShowSignUp(true); setShowSignIn(false); }}>
              Sign Up
            </Button>
            <Button variant="outlined" color="primary" fullWidth onClick={() => { setShowSignIn(true); setShowSignUp(false); }} sx={{ mt: 2 }}>
              Sign In
            </Button>
          </Box>
        )}
        ...
        {showSignUp && (
          <React.Fragment>
            ...
            <form action="http://localhost:8080/signup" method="post">
              ...
              <Button type="button" variant="text" color="secondary" fullWidth onClick={() => setShowSignUp(false)} sx={{ mt: 1 }}>
                Cancel
              </Button>
            </form>
          </React.Fragment>
        ...
        {showSignIn && (
          <React.Fragment>
            ...
            <form action="http://localhost:8080/login/password" method="post">
              ...
              <Button type="button" variant="text" color="secondary" fullWidth onClick={() => setShowSignIn(false)} sx={{ mt: 1 }}>
                Cancel
              </Button>
            </form>
          </React.Fragment>
        ...
        <Box sx={{ mt: 2, width: '100%' }}>
          <Typography component="h1" variant="h6" align="center" sx={{ mt: 4, mb: 2 }}>
            Login with Google or Spotify
          </Typography>
          <Button variant="outlined" href="http://localhost:8080/login/federated/google" fullWidth sx={{ mb: 1 }}>
            Log In with Google
          </Button>
          <Button variant="outlined" href="http://localhost:8080/auth/spotify" fullWidth>
            Log In with Spotify
          </Button>
        </Box>
      </Paper>
